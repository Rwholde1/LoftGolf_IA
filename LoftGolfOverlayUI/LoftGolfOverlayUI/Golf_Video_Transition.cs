    ...
    public partial class Golf_Video_Transition : Form
    {
        ...
        private void Golf_Video_Transition_Shown(object sender, EventArgs e)
        {
            if (userType == Golf_New_Returning_User.userType.returningUser)
            {
                ...
                axWindowsMediaPlayer1.URL = @"C:\Users\RoadK\Documents\Unity\LoftGolf_IA\LoftGolfOverlayUI\LoftGolfOverlayUI\testvideo.mp4";
                axWindowsMediaPlayer1.uiMode = "none";
            }
            else
            {
                label1.Text = "Please watch this video to learn how to golf!";
                axWindowsMediaPlayer1.URL = @"C:\Users\RoadK\Documents\Unity\LoftGolf_IA\LoftGolfOverlayUI\LoftGolfOverlayUI\testvideo2.mp4";
                axWindowsMediaPlayer1.uiMode = "none";
            }
